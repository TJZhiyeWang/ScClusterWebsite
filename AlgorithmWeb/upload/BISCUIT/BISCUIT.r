CK1 <- c(3,6,6,9,11,10,3,10,17,8,7) # sc3 estimated
setwd("/Users/ruiyi/Documents/Project/CLUST/code/BISCUIT/BISCUIT_SingleCell_IMM_ICML_2016-master")
library(MCMCpack)
library(mvtnorm)
library(ellipse)
library(coda)
...
input_file_name <- "~/Documents/Project/CLUST/data/1_data.txt";
