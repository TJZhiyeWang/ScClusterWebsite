...
##ref: http://stackoverflow.com/questions/15282580/how-to-generate-a-number-of-most-distinctive-co
...
source("/home/projects/AlgorithmWeb/upload/BISCUIT/BISCUIT_process_data.R");
...
source("/home/projects/AlgorithmWeb/upload/BISCUIT/BISCUIT_IMM_Gibbs_MCMC_parallel.R")

#3) Postprocess MCMC chains from multiple parallel runs
source("/home/projects/AlgorithmWeb/upload/BISCUIT/BISCUIT_post_MCMC_genesplit_merge.R")

#4) Compute imputed data based on inferred variables and generate plots
source("/home/projects/AlgorithmWeb/upload/BISCUIT/BISCUIT_post_process.R")
########################################

#print(Sys.time() - start_time_overall)
curr_time <- Sys.time()
print(curr_time - start_time_overall)
write(paste0('Overall run time: ',curr_time - start_time_overall),file=f1, append=TRUE)
